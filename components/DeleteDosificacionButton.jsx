...
export default function DeleteDosificacionButton({idusuario, idcarrera, idmateria}) {
    const handleRemoveDosificacion = async () => {
        console.log(idusuario, idcarrera, idmateria)
        // const response = await fetch(`http://localhost:3000/api/dosificacion?idusuario=${id}&idcarrera=${id}&idmateria=${id}`
    }
